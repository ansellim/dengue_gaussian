...
# --- Baseline: Singapore mean temperature ~27C ---
# Chan & Johansson (2012): interpolating between 25C (15d) and 30C (6.5d)
# gives EIP ~11d at 27C. Corroborated by Rohani et al. (2009): first
# detection at day 9 at 26C and 28C (means are longer than first detection).
gi_base <- compute_gi_from_components(eip_mean = 11, eip_sd = 4)
gi_baseline <- gi_base$pmf

cat("\n  Component breakdown (baseline, ~27C):\n")
