...
for (i in 1:n_sims) {
  ...
  phi <- abs(rnorm(1, 0, 5))  # Half-normal
...
cat("=" |> rep(70) |> paste(collapse = ""), "\n")
cat("\nNext step: Fit the model, then run 07_posterior_predictive.R\n")
