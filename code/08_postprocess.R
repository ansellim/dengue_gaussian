...
# 08_postprocess.R
#
# Posterior summaries, decomposition plots, and diagnostics for the climate-only
# model (temperature + rainfall + residual GP)
#
...
if (!file.exists(fit_file)) {
  stop("No fitted model found. Run 06_fit_model.R first.")
}
